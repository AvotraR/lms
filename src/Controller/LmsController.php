...
class LmsController extends AbstractController
{
    ...
    public function voirProduit(MatiereRepository $matiereRepo, $id)
    {
    ...
    public function afficherAchat(MatiereRepository $MatiereRepo,SessionInterface $session)
    {
    ...
    public function validationAchat(MatiereRepository $MatiereRepo,SessionInterface $session)
    {
        $user = $this->getUser();
        $panier = $session->get("panier",[]);
        $dataPanier = [];
    ...
    public function ajouterAchat( $id ,SessionInterface $session)
    {
        $panier = $session->get("panier", []);
    ...
    public function supprimerAchat( $id ,SessionInterface $session)
    {
        $panier = $session->get("panier", []);
